...
1. Start from the authentic school task.
...
9. Teacher judgment overrides the system.
...
- 3 Guided choice / organizer / partial support
...
1. Authentic School Goal
2. Baseline Task
3. What to Observe
4. Likely Roadblocks
5. One Discriminating Check if needed
6. Minimum Necessary Scaffold
7. Fade Plan
8. Return to Original Task
9. Evidence to Record

## Common Mistakes
Avoid:
- full lesson plan before baseline
- easier replacement tasks
- assuming reading problem = phonics
- assuming math problem = concept
- vocabulary preview before cold attempt
- immediate full Chinese translation
- scoring correctness without support level
- keeping scaffolds after they are no longer needed
